...
public class ColorChooser extends AbstractWidget {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
        ...
        buffer.addVertex(posMatrix, (float) leftX, (float) topY, 0).setColor(hue, 0f, 1f, 1f);
        buffer.addVertex(posMatrix, (float) leftX, (float) botY, 0).setColor(hue, 0f, 0f, 1f);
        buffer.addVertex(posMatrix, (float) rightX, (float) botY, 0).setColor(hue, 1f, 0f, 1f);
        buffer.addVertex(posMatrix, (float) rightX, (float) topY, 0).setColor(hue, 1f, 1f, 1f);
        ...
        buffer.addVertex(posMatrix, (float) leftX, (float) topY, 0).setColor(1f, 1f, 1f, 1f);
        buffer.addVertex(posMatrix, (float) leftX, (float) botY, 0).setColor(0f, 1f, 1f, 1f);
        buffer.addVertex(posMatrix, (float) rightX, (float) botY, 0).setColor(0f, 1f, 1f, 1f);
        buffer.addVertex(posMatrix, (float) rightX, (float) topY, 0).setColor(1f, 1f, 1f, 1f);
